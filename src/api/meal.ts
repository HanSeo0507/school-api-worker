...
export const getMealBySchoolCode = async (officeDistrictCode: string, schoolCode: string, options?: NeisAPIOptions & { MLSV_YMD: string; MLSV_FROM_YMD: string; MLSV_TO_YMD: string }) => {
